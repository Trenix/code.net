    ...
    def reveal(self):
        ...
        if globals.revealtracker <= globals.players:
            ...
            if self.ids[f"ind{globals.revealtracker}"].icon == "circle-slice-8" and globals.playerlist[f"player {globals.revealtracker}"]["hacker"] == True and globals.revealtracker <= globals.players:
                ...
                tempdialog.ids.whatcolor.text = "[u]Color[/u]: " + f"[size=18sp][color={globals.colordefs[playercolor]}][font=Icons]{md_icons['account']}[/font][/color][/size] " + playercolor
                ...
                if globals.players <= 8:
                    ...
                    tempdialog.ids.haveallies.text = "[u]Ally[/u]: " + f"[size=18sp][color={globals.colordefs[allycolor]}][font=Icons]{md_icons['account-plus']}[/font][/color][/size] " + globals.playerlist[ally]["color"]
                    tempdialog.open()
                    ...
                    tempdialog.ids.haveallies.text = "[u]Allies[/u]: " + f"[size=18sp][color={globals.colordefs[allycolor1]}][font=Icons]{md_icons['account-plus']}[/font][/color][/size] " + allycolor1 + ", " + f"[size=18sp][color={globals.colordefs[allycolor2]}][font=Icons]{md_icons['account-plus']}[/font][/color][/size] " + allycolor2
                    tempdialog.open()
