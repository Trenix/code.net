    ...
    def reveal(self):
        ...
        if globals.revealtracker <= globals.players:
            ...
            if self.ids[f"ind{globals.revealtracker}"].icon == "circle-slice-8" and globals.playerlist[f"player {globals.revealtracker}"]["hacker"] == True and globals.revealtracker <= globals.players:
                ...
                tempdialog.ids.whatcolor.text = "[u]Color[/u]: " + f"[size=16sp][color={globals.colordefs2[playercolor]}][font=Icons]{md_icons['account']}[/font][/color][/size] " + playercolor
                tempdialog.ids.arehacker.text = "[u]Alignment[/u]: " + f"[size=16sp][color=#c62828][font=Icons]{md_icons['shield-bug']}[/font][/color][/size] " + "Hacker"
                ...
                if globals.players <= 8:
                    ...
                    tempdialog.ids.haveallies.text = "[u]Ally[/u]: " + f"[size=16sp][color={globals.colordefs2[allycolor]}][font=Icons]{md_icons['account-plus']}[/font][/color][/size] " + globals.playerlist[ally]["color"]
                    tempdialog.open()
                    ...
                    tempdialog.ids.haveallies.text = "[u]Allies[/u]: " + f"[size=16sp][color={globals.colordefs2[allycolor1]}][font=Icons]{md_icons['account-plus']}[/font][/color][/size] " + allycolor1 + ", " + f"[size=16sp][color={globals.colordefs2[allycolor2]}][font=Icons]{md_icons['account-plus']}[/font][/color][/size] " + allycolor2
                    tempdialog.open()
                ...
                tempdialog.ids.whatcolor.text = "[u]Color[/u]: " + f"[size=16sp][color={globals.colordefs2[playercolor]}][font=Icons]{md_icons['account']}[/font][/color][/size] " + playercolor
                tempdialog.ids.arehacker.text = "[u]Alignment[/u]: " + f"[size=16sp][color=#1565c0][font=Icons]{md_icons['shield-lock']}[/font][/color][/size] " + "Coder"
                if globals.amtbad == 2:
                    amthackers = "two"
                else:
                    amthackers = "three"
