...
class PlayerWindow(MDScreen):
    ...
    def setplayervars(self):
        ...
        if self.ids.butt1.state == "down":
            ...
            globals.players = 4
            globals.aiamt = 1
            self.manager.get_screen("main").ids.playeridentifer.text = f"[size=22sp][font=Icons]{md_icons['account-circle']}\n{md_icons['numeric-1-circle']}\n[color=#2e7d32]{md_icons['account-supervisor-circle']}\n{md_icons['numeric-4-circle']}[/color][/font]"

            self.manager.get_screen("main").ids.alignmentidentifer.text = f"[size=22sp][font=Icons][color=#c62828]{md_icons['shield-bug']}\n{md_icons['numeric-2-circle']}\n[/color][color=#1565c0]{md_icons['shield-lock']}\n{md_icons['numeric-3-circle']}[/color][/font]"
        ...
        # 5 players
            ...
            self.manager.get_screen("main").ids.playeridentifer.text = f"[size=22sp][font=Icons]{md_icons['account-circle']}\n{md_icons['numeric-1-circle']}\n[color=#2e7d32]{md_icons['account-supervisor-circle']}\n{md_icons['numeric-5-circle']}[/color][/font]"
        ...
        # 6 players
            ...
            globals.players = 6
            globals.aiamt = 0
            self.manager.get_screen("main").ids.playeridentifer.text = f"[size=22sp][font=Icons]{md_icons['account-circle']}\n{md_icons['numeric-0-circle']}\n[color=#2e7d32]{md_icons['account-supervisor-circle']}\n{md_icons['numeric-6-circle']}[/color][/font]"
        ...
        # 7 players
            ...
            globals.players = 7
            globals.aiamt = 0
            self.manager.get_screen("main").ids.playeridentifer.text = f"[size=22sp][font=Icons]{md_icons['account-circle']}\n{md_icons['numeric-0-circle']}\n[color=#2e7d32]{md_icons['account-supervisor-circle']}\n{md_icons['numeric-7-circle']}[/color][/font]"
        ...
        # 8 players
            ...
            globals.players = 8
            globals.aiamt = 0
            self.manager.get_screen("main").ids.playeridentifer.text = f"[size=22sp][font=Icons]{md_icons['account-circle']}\n{md_icons['numeric-0-circle']}\n[color=#2e7d32]{md_icons['account-supervisor-circle']}\n{md_icons['numeric-8-circle']}[/color][/font]"
        ...
        # 9 players
            ...
            self.manager.get_screen("main").ids.playeridentifer.text = f"[size=22sp][font=Icons]{md_icons['account-circle']}\n{md_icons['numeric-0-circle']}\n[color=#2e7d32]{md_icons['account-supervisor-circle']}\n{md_icons['numeric-9-circle']}[/color][/font]"

            self.manager.get_screen("main").ids.alignmentidentifer.text = f"[size=22sp][font=Icons][color=#c62828]{md_icons['shield-bug']}\n{md_icons['numeric-3-circle']}\n[/color][color=#1565c0]{md_icons['shield-lock']}\n{md_icons['numeric-6-circle']}[/color][/font]"
