...
class EndGame(MDScreen):
    ...
    # Reveals actions
        for num in range(4):
            ...
            f"[size=22sp][color={globals.actionicons[globals.playeractions[list(globals.playeractions)[num]]['Action']]['color']}][font=Icons]{md_icons[globals.actionicons[globals.playeractions[list(globals.playeractions)[num]]['Action']]['icon']]}[/font][/color][/size] [color={globals.playeractions[list(globals.playeractions)[num]]['TargetColor']}]{globals.playeractions[list(globals.playeractions)[num]]['Target']}[/color]"
