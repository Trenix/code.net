...
def createplayerlog(logplayer):
    ...
    strtempplayerlog = f"[color={globals.colordefs[tempplayercolorlog[0]]}][size=30sp][font=Icons]{md_icons['folder-account']}[/font][/color] " \
                 f"[color={globals.colordefs[tempplayercolorlog[1]]}][size=30sp][font=Icons]{md_icons['folder-account']}[/font][/color] "
